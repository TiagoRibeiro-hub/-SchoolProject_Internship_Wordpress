                ...
                <div class="container">
                    <div class="row category-posts-content-div"><?php
                        ...
                        <div class="col-md-4 category-posts-content-items">
                                ...
                                <h4><?php the_title(); ?></h4>
                                <p><?php the_excerpt(); ?></p>   
                                <h6 class="category-h6-link category-pag-link"><a class="category-posts-content-items" href="<?php  echo esc_url(get_permalink()); ?>">Read it... //</a></h6>
                                <h6 class="category-h6-link category-pag-link">
                                    <?php
